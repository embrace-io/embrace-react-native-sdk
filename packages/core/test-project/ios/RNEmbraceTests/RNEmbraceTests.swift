...
final class TestExporter : EmbraceSpanExporter {
...
final class EmbraceSpansTests: XCTestCase {
    ...
    func getExportedSpans() async throws -> [SpanData] {
        try await Task.sleep(nanoseconds: UInt64(5.0 * Double(NSEC_PER_SEC)))
        return EmbraceSpansTests.exporter.exportedSpans.filter { span in !EMBRACE_INTERNAL_SPAN_NAMES.contains(span.name)}
    }
    
    func testStartSpan() async throws {
        module.startSpan("my-span", parentSpanId: "", startTimeMS: 0.0, resolver: promise.resolve, rejecter: promise.reject)
        module.startSpan("span-never-stopped", parentSpanId: "", startTimeMS: 0.0, resolver: promise.resolve, rejecter: promise.reject)
        XCTAssertEqual(promise.resolveCalls.count, 2)
        let spanId = (promise.resolveCalls[0] as? String)!
        module.stopSpan(spanId, errorCodeString: "", endTimeMS: 0.0, resolver: promise.resolve, rejecter: promise.reject)
    ...
    func testStartSpanWithParent() async throws {
        module.startSpan("parent-span", parentSpanId: "", startTimeMS: 0.0, resolver: promise.resolve, rejecter: promise.reject)
        XCTAssertEqual(promise.resolveCalls.count, 1)
        let parentSpanId = (promise.resolveCalls[0] as? String)!
        promise.reset()
        
        module.startSpan("child-span", parentSpanId: parentSpanId, startTimeMS: 0.0, resolver: promise.resolve, rejecter: promise.reject)
        XCTAssertEqual(promise.resolveCalls.count, 1)
        let childSpanId = (promise.resolveCalls[0] as? String)!
        
        module.stopSpan(parentSpanId, errorCodeString: "", endTimeMS: 0.0, resolver: promise.resolve, rejecter: promise.reject)
        module.stopSpan(childSpanId, errorCodeString: "", endTimeMS: 0.0, resolver: promise.resolve, rejecter: promise.reject)
    ...
    func testStartSpanWithStoppedParent() async throws {
        module.startSpan("stopped-parent-span", parentSpanId: "", startTimeMS: 0.0, resolver: promise.resolve, rejecter: promise.reject)
        XCTAssertEqual(promise.resolveCalls.count, 1)
        let parentSpanId = (promise.resolveCalls[0] as? String)!
        module.stopSpan(parentSpanId, errorCodeString: "", endTimeMS: 0.0, resolver: promise.resolve, rejecter: promise.reject)
        promise.reset()
    ...
    func testStartSpanWithTimes() async throws {
        module.startSpan("span-with-times", parentSpanId: "", startTimeMS: 1721765402001.0, resolver: promise.resolve, rejecter: promise.reject)
        XCTAssertEqual(promise.resolveCalls.count, 1)
        let spanId = (promise.resolveCalls[0] as? String)!
        module.stopSpan(spanId, errorCodeString: "", endTimeMS:  1721765409002.0, resolver: promise.resolve, rejecter: promise.reject)
    ...
    func testStopSpanWithErrorCode() async throws {
        module.startSpan("failure-span", parentSpanId: "", startTimeMS: 0.0, resolver: promise.resolve, rejecter: promise.reject)
        module.startSpan("user-abandon-span", parentSpanId: "", startTimeMS: 0.0, resolver: promise.resolve, rejecter: promise.reject)
        module.startSpan("unknown-span", parentSpanId: "", startTimeMS: 0.0, resolver: promise.resolve, rejecter: promise.reject)
        module.startSpan("invalid-error-code-span", parentSpanId: "", startTimeMS: 0.0, resolver: promise.resolve, rejecter: promise.reject)
        ...
        module.stopSpan(failureSpanId, errorCodeString: "Failure", endTimeMS: 0.0, resolver: promise.resolve, rejecter: promise.reject)
        module.stopSpan(userAbandonSpanId, errorCodeString: "UserAbandon", endTimeMS: 0.0, resolver: promise.resolve, rejecter: promise.reject)
        module.stopSpan(unknownSpanId, errorCodeString: "Unknown", endTimeMS: 0.0, resolver: promise.resolve, rejecter: promise.reject)
        module.stopSpan(invalidErrorCodeSpanId, errorCodeString: "foo", endTimeMS: 0.0, resolver: promise.resolve, rejecter: promise.reject)
    ...
    func testStopSpanInvalidId() async throws {
        module.stopSpan("invalid", errorCodeString: "", endTimeMS: 0.0, resolver: promise.resolve, rejecter: promise.reject)
    ...
    func testAddSpanEvent() async throws {
        ...
        module.addSpanEventToSpan(spanId, name: "my-event", time: 1721765404001.0, attributes: NSDictionary(), resolver: promise.resolve, rejecter: promise.reject)
        XCTAssertEqual(promise.resolveCalls.count, 2)
        XCTAssertTrue((promise.resolveCalls[1] as? Bool)!)
        module.stopSpan(spanId, errorCodeString: "", endTimeMS: 0.0, resolver: promise.resolve, rejecter: promise.reject)
        // Events added after the span ends should be ignored
        module.addSpanEventToSpan(spanId, name: "my-event-after-stop", time: 0.0, attributes: NSDictionary(), resolver: promise.resolve, rejecter: promise.reject)
    ...
    func testAddSpanEventWithAttributes() async throws {
        ...
        module.addSpanEventToSpan(spanId, name: "my-event", time: 1721765404001.0, attributes: NSDictionary(dictionary:[
            "my-attr1": "foo",
            "my-attr2": "bar",
    ...
    func testAddSpanEventInvalidId() async throws {
        module.addSpanEventToSpan("invalid", name: "my-event", time: 1721765404001.0, attributes: NSDictionary(), resolver: promise.resolve, rejecter: promise.reject)
        XCTAssertEqual(promise.resolveCalls.count, 0)
        XCTAssertEqual(promise.rejectCalls.count, 1)
        XCTAssertEqual(promise.rejectCalls[0], "Could not retrieve a span with the given id")
    }
    ...
    func testAddSpanAttribute() async throws {
        ...
        module.addSpanAttributeToSpan(spanId, key: "my-attr1", value: "foo", resolver: promise.resolve, rejecter: promise.reject)
        XCTAssertEqual(promise.resolveCalls.count, 2)
        XCTAssertTrue((promise.resolveCalls[1] as? Bool)!)
        module.addSpanAttributeToSpan(spanId, key: "my-attr2", value: "bar", resolver: promise.resolve, rejecter: promise.reject)
        module.stopSpan(spanId, errorCodeString: "", endTimeMS: 0.0, resolver: promise.resolve, rejecter: promise.reject)
        // Attributes added after the span ends should be ignored
        module.addSpanAttributeToSpan(spanId, key: "my-attr3", value: "baz", resolver: promise.resolve, rejecter: promise.reject)
    ...
    func testAddSpanAttributeInvalidId() async throws {
        module.addSpanAttributeToSpan("invalid", key: "my-attr1", value: "foo", resolver: promise.resolve, rejecter: promise.reject)
        XCTAssertEqual(promise.resolveCalls.count, 0)
        XCTAssertEqual(promise.rejectCalls.count, 1)
        XCTAssertEqual(promise.rejectCalls[0], "Could not retrieve a span with the given id")
    }
    ...
    func testRecordCompletedSpan() async throws {
        ...
        module.recordCompletedSpan("my-span", startTimeMS: 1721765404001.0, endTimeMS: 1721765407003.0, errorCodeString: "", parentSpanId: "", attributes: attributes, events: events, resolver: promise.resolve, rejecter: promise.reject)
        XCTAssertEqual(promise.resolveCalls.count, 1)
        XCTAssertTrue((promise.resolveCalls[0] as? Bool)!)
    ...
    func testRecordCompletedSpanWithParent() async throws {
        ...
        module.recordCompletedSpan("my-span-valid-parent", startTimeMS: 0.0, endTimeMS: 0.0, errorCodeString: "", parentSpanId: parentSpanId, attributes: NSDictionary(), events: NSArray(), resolver: promise.resolve, rejecter: promise.reject)
        // An invalid parent ID shouldn't prevent the span from otherwise being recorded
        module.recordCompletedSpan("my-span-invalid-parent", startTimeMS: 0.0, endTimeMS: 0.0, errorCodeString: "", parentSpanId: "invalid", attributes: NSDictionary(), events: NSArray(), resolver: promise.resolve, rejecter: promise.reject)
        XCTAssertEqual(promise.resolveCalls.count, 2)
        XCTAssertTrue((promise.resolveCalls[0] as? Bool)!)
        XCTAssertTrue((promise.resolveCalls[1] as? Bool)!)
...
final class EmbraceSpansSDKNotStartedTests: XCTestCase {
    ...
    func testRecordCompletedSpanEmbraceNotStarted() async throws {
        module.recordCompletedSpan("my-span", startTimeMS: 0.0, endTimeMS: 0.0, errorCodeString: "", parentSpanId: "", attributes: NSDictionary(), events: NSArray(), resolver: promise.resolve, rejecter: promise.reject)
        XCTAssertEqual(promise.resolveCalls.count, 0)
        XCTAssertEqual(promise.rejectCalls.count, 1)
