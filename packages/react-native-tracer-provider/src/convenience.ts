 ...
 */
const startView = (tracer: Tracer, viewName: string): Span =>
 ...
 */
const asParent = (span: Span) => trace.setSpan(context.active(), span);
...
type CompletedSpanOptions = SpanOptions & {
  parent?: Span;
  events?: {
    name: string;
...
export {startView, endAsFailed, asParent, recordCompletedSpan};
export type {CompletedSpanOptions};
